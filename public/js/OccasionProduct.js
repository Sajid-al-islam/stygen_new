(self["webpackChunk"] = self["webpackChunk"] || []).push([["OccasionProduct"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/product/OccasionProduct.vue?vue&type=script&lang=js&":
/*!***************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/product/OccasionProduct.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    openModal: function openModal() {
      jquery__WEBPACK_IMPORTED_MODULE_3___default()("#shoppingCart").modal('show');
    },
    ...
    getSingleProductSlider: function getSingleProductSlider() {
      var payload = {
        'occasion_slug': this.$route.params.occasionSlug
      };
      this.$store.dispatch('slider/getSingleProductSlider', payload);
    },
    productList: function productList() {
      var payload = {
        'page': this.currentPage,
        'occasion_slug': this.$route.params.occasionSlug,
        'ocassion_cat': this.ocassion_cat
      };
      this.$store.dispatch('product/getOccasionProducts', payload);
    },
    // ocassion_categories(){
    //     this.$store.dispatch('product/getOccasionProducts')
    //     console.log(this.$store.dispatch('product/getOccasionProducts'));
    // },
    ...
    getOccasionSlug: function getOccasionSlug() {
      var _this = this;

      axios.post('/occasion-product-slug', {
        'occasion_slug': this.$route.params.occasionSlug
      }).then(function (result) {
        _this.occasion_slug_name = result.data.occasion_name;
        _this.occasion_slug = result.data.occasion_slug;
          ...
          if (this.color_msg == false && this.size_msg == false && this.weight_msg == false) {
            axios.post('/cart/add-to-cart', {
              ...
              if (result.data == 'error') {
                ...
                _this2.cartMsg = false;

                _this2.$store.dispatch('cart/productList');
    ...
    quickView: function quickView(product, image, attributes) {
      ...
      axios.post('/get-variations', {
        ...
        _this4.all_attributes = result.data.all_attributes;
      })["catch"](function (error) {});
    },
    ...
    productSorting: function productSorting(event) {
      ...
      var payload = {
        ...
        'occasion_slug': this.occasion_slug
      };
      this.$store.dispatch('product/occassionProductSort', payload);
    },
    Ocassion_product_sort: function Ocassion_product_sort() {
      var payload = {
        'page': this.currentPage,
        'keyword': '',
        'occasion_slug': this.occasion_slug,
      ...
      this.$store.dispatch('product/occassionProductSortByCat', payload);
    },
    productOccassionName: function productOccassionName() {
      axios.post('/product-occassion-name', {
        'occasionSlug': this.$route.params.occasionSlug
      }).then(function (result) {
        console.log(result);
        document.title = result.data.occasion_name + ' | Stygen';
      })["catch"](function (error) {});
    },
    ocassion_categories: function ocassion_categories() {
      var _this5 = this;

      axios.post('/ocassion-product-category', {
        'occasionSlug': this.$route.params.occasionSlug
      }).then(function (result) {
        _this5.occasion_categories = result.data.ocassion_categories.slice().reverse(); // this.occasion_slug = result.data.occasion_slug
      })["catch"](function (error) {});
    }
  },
  watch: {
    '$route.path': function $routePath(val, oldVal) {
      this.init_component();
      this.productOccassionName();
    },
    ocassion_cat: function ocassion_cat(after, before) {
  ...
  computed: {
    ...
    sliders: function sliders() {
      return this.$store.getters['slider/getSingleProductSlider'];
    }
  },
  created: function created() {
    this.productList();
    this.ocassion_categories();
    this.getOccasionSlug();
    this.init_component();
    this.getSingleProductSlider();
    this.isMobile();
    this.productOccassionName();
  }
});
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/product/OccasionProduct.vue?vue&type=style&index=0&id=5b602896&scoped=true&lang=css&":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/product/OccasionProduct.vue?vue&type=style&index=0&id=5b602896&scoped=true&lang=css& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_OccasionProduct_vue_vue_type_style_index_0_id_5b602896_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./OccasionProduct.vue?vue&type=style&index=0&id=5b602896&scoped=true&lang=css& */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/product/OccasionProduct.vue?vue&type=style&index=0&id=5b602896&scoped=true&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_OccasionProduct_vue_vue_type_style_index_0_id_5b602896_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./resources/js/components/frontend/product/OccasionProduct.vue":
/*!**********************************************************************!*\
  !*** ./resources/js/components/frontend/product/OccasionProduct.vue ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _OccasionProduct_vue_vue_type_template_id_5b602896_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./OccasionProduct.vue?vue&type=template&id=5b602896&scoped=true& */ "./resources/js/components/frontend/product/OccasionProduct.vue?vue&type=template&id=5b602896&scoped=true&");
/* harmony import */ var _OccasionProduct_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./OccasionProduct.vue?vue&type=script&lang=js& */ "./resources/js/components/frontend/product/OccasionProduct.vue?vue&type=script&lang=js&");
/* harmony import */ var _OccasionProduct_vue_vue_type_style_index_0_id_5b602896_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./OccasionProduct.vue?vue&type=style&index=0&id=5b602896&scoped=true&lang=css& */ "./resources/js/components/frontend/product/OccasionProduct.vue?vue&type=style&index=0&id=5b602896&scoped=true&lang=css&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _OccasionProduct_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _OccasionProduct_vue_vue_type_template_id_5b602896_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _OccasionProduct_vue_vue_type_template_id_5b602896_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "5b602896",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/frontend/product/OccasionProduct.vue"
...
/***/ "./resources/js/components/frontend/product/OccasionProduct.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************!*\
  !*** ./resources/js/components/frontend/product/OccasionProduct.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_OccasionProduct_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./OccasionProduct.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/product/OccasionProduct.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_OccasionProduct_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/components/frontend/product/OccasionProduct.vue?vue&type=style&index=0&id=5b602896&scoped=true&lang=css&":
/*!*******************************************************************************************************************************!*\
  !*** ./resources/js/components/frontend/product/OccasionProduct.vue?vue&type=style&index=0&id=5b602896&scoped=true&lang=css& ***!
  \*******************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_OccasionProduct_vue_vue_type_style_index_0_id_5b602896_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./OccasionProduct.vue?vue&type=style&index=0&id=5b602896&scoped=true&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/product/OccasionProduct.vue?vue&type=style&index=0&id=5b602896&scoped=true&lang=css&");


/***/ }),

/***/ "./resources/js/components/frontend/product/OccasionProduct.vue?vue&type=template&id=5b602896&scoped=true&":
/*!*****************************************************************************************************************!*\
  !*** ./resources/js/components/frontend/product/OccasionProduct.vue?vue&type=template&id=5b602896&scoped=true& ***!
  \*****************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_OccasionProduct_vue_vue_type_template_id_5b602896_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_OccasionProduct_vue_vue_type_template_id_5b602896_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_OccasionProduct_vue_vue_type_template_id_5b602896_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./OccasionProduct.vue?vue&type=template&id=5b602896&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/product/OccasionProduct.vue?vue&type=template&id=5b602896&scoped=true&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/product/OccasionProduct.vue?vue&type=template&id=5b602896&scoped=true&":
/*!********************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/product/OccasionProduct.vue?vue&type=template&id=5b602896&scoped=true& ***!
  \********************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  return _c("div", { attrs: { id: "occasion_product" } }, [
    _c("div", { staticClass: "slider-area" }, [
      _c("div", { class: { container: _vm.isActive } }, [
                  ...
                  ? _c(
                      ...
                      _vm._l(_vm.sliders, function(slider, index) {
                        return _c("img", {
                          key: index,
                          attrs: {
                            src: "/assets/uploads/slider/" + slider.image,
                            alt: slider.title
                          }
                        })
                      }),
    ...
    _vm._v(" "),
    _c("div", { staticClass: "shop-area container occasionShop" }, [
      _c("div", { staticClass: "main-design" }, [
        _c("div", { staticClass: "row" }, [
          _c("div", { staticClass: "col-lg-12 order-1 order-lg-2" }, [
            _c("div", { staticClass: "shop-layout" }, [
              ...
              _vm._v(" "),
              _c("h4", { staticClass: "mb-2" }, [_vm._v("Filter by Category")]),
              _vm._v(" "),
              _c("div", { staticClass: "container-fluid filter mb-4" }, [
                _c(
                  "div",
                  { staticClass: "row" },
                  [
                    _c(
                      ...
                      _vm._l(_vm.occasion_categories, function(pro_category) {
                        return _c("span", { key: pro_category.id }, [
                          _c("input", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.ocassion_cat,
                                expression: "ocassion_cat"
                              }
                            ],
                            staticClass: "ocassion_cat",
                            attrs: { type: "radio", id: pro_category.id },
                            domProps: {
                              value: pro_category.id,
                              checked: _vm._q(_vm.ocassion_cat, pro_category.id)
                            },
                            on: {
                              change: function($event) {
                                _vm.ocassion_cat = pro_category.id
                              }
                            }
                          }),
                          _vm._v(" "),
                          _c(
                            "label",
                            {
                              ...
                              attrs: { for: pro_category.id }
                            },
                            [_vm._v(_vm._s(pro_category.category_name))]
                          )
                        ])
                      }),
                      0
