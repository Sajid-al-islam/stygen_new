(self["webpackChunk"] = self["webpackChunk"] || []).push([["SingleProductComponent"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/product/SingleProductComponent.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/product/SingleProductComponent.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  metaInfo: {
    meta: [{
      property: 'title',
      content: localStorage.getItem('meta_title')
    }, {
  ...
  methods: {
    openModal: function openModal() {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()("#shoppingCart").modal('show');
    },
    ...
    facebookViewContent: function facebookViewContent() {
      var product_slug = this.$route.params.slug;
      axios.post('/get-view-content', {
    ...
    googleview: function googleview() {
      var product_slug = this.$route.params.slug;
      axios.post('/get-view-content', {
        'product_slug': product_slug
      }).then(function (result) {
    ...
    sendReview: function sendReview() {
      ...
      axios.post('/user/product-review', {
        'product_id': this.product.id,
        'rating': this.rating,
        'review_description': this.review_description,
        'user_id': this.user.id
      }).then(function (result) {
        _this2.$store.dispatch('product/getSingleProduct', _this2.$route.params.slug);

        _this2.rating = 0;
        _this2.review_title = '';
        _this2.review_description = '';
    ...
    singleProductCategory: function singleProductCategory() {
      var _this3 = this;

      axios.post('/single-product-category', {
        'product_slug': this.$route.params.slug
      }).then(function (result) {
        _this3.categoryName = result.data.category_name;
        _this3.categorySlug = result.data.cat_slug;
      })["catch"](function (error) {});
    },
    init_component: function init_component() {
      this.getSingleProduct();
      this.getRelatedProduct(); // this.getTrendingProduct();
    },
    ...
    getAllOccasion: function getAllOccasion() {
    ...
    addToCart: function addToCart(product) {
      ...
      var sku = product.id; // console.log(product.id);
    ...
    addToCartRelated: function addToCartRelated(product) {
      var _this5 = this;
      ...
      axios.post('/cart/add-to-cart', {
        ...
        if (result.data == 'error') {
          ...
          _this5.cartMsg = false;

          _this5.$store.dispatch('cart/productList');
    ...
    buyNow: function buyNow(product) {
      var _this6 = this;
          ...
          if (this.color_msg == false && this.size_msg == false && this.weight_msg == false) {
            axios.post('/cart/add-to-cart', {
              ...
              if (result.data == 'error') {
                ...
                // this.openModal();
                _this6.cartMsg = false;

                _this6.$store.dispatch('cart/productList');

                _this6.$router.push('/checkout');
    ...
    productView: function productView() {
      var _this7 = this;

      axios.post('/product-view-by-user', {
        'product_slug': this.$route.params.slug
      }).then(function (result) {
        // console.log(result.data)
        _this7.productId = result.data.id;
        ...
        _this7.meta_title = result.data.meta_title;
        _this7.meta_des = result.data.meta_description;
        _this7.meta_image = result.data.meta_image;
      })["catch"](function (error) {});
    },
    getstock: function getstock() {
      var _this8 = this;

      axios.post('/get-product-stock', {
        'slug': this.$route.params.slug
      }).then(function (res) {
        _this8.product_stock = res.data.product_quantity;
        console.log(_this8.product_stock, 'product-id', _this8.product.id, 'quantity =>', res.product_quantity, res);
      });
    }
  },
  computed: {
    ...
    get_addon_products: function get_addon_products() {
    ...
    all_attributes: function all_attributes() {
  ...
  created: function created() {
    this.productView();
    this.getSingleProduct();
    this.getRelatedProduct(); // this.getAddonProduct();
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/product/SingleProductComponent.vue?vue&type=style&index=0&id=5575ea18&scoped=true&lang=css&":
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/product/SingleProductComponent.vue?vue&type=style&index=0&id=5575ea18&scoped=true&lang=css& ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.add-on[data-v-5575ea18] {\r\n    background-color: #573276e0;\r\n    padding: 5px;\n}\n.add-on h4[data-v-5575ea18]{\r\n    margin-left: 5px;\r\n    padding-top: 3px;\n}\n.addtocart[data-v-5575ea18] {\r\n    background-color: #5e2e87;\r\n    font-size: 12px;\r\n    text-transform: capitalize;\n}\n.addtocart i[data-v-5575ea18] {\r\n    margin-right: 5px;\r\n    padding-left: 1px;\n}\n.detailsbtn[data-v-5575ea18] {\r\n    background-color: #5e2e87;\r\n    color: white !important;\r\n    font-size: 12px;\r\n    text-transform: capitalize;\n}\n#detailsbtn[data-v-5575ea18] {\r\n    color: white !important;\r\n    font-size: 12px;\r\n    text-transform: capitalize;\n}\n#buynowbtn[data-v-5575ea18] {\r\n    background-color: #5e2e87;\r\n    padding: 17px;\r\n    text-transform: capitalize;\n}\n#buynowbtn i[data-v-5575ea18]{\r\n    padding-right: 12px;\n}\n.justify-content-start[data-v-5575ea18] {\r\n    margin-right: 20px;\n}\r\n", ""]);
// Exports
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_SingleProductComponent_vue_vue_type_style_index_0_id_5575ea18_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./SingleProductComponent.vue?vue&type=style&index=0&id=5575ea18&scoped=true&lang=css& */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/product/SingleProductComponent.vue?vue&type=style&index=0&id=5575ea18&scoped=true&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_SingleProductComponent_vue_vue_type_style_index_0_id_5575ea18_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./resources/js/components/frontend/product/SingleProductComponent.vue":
/*!*****************************************************************************!*\
  !*** ./resources/js/components/frontend/product/SingleProductComponent.vue ***!
  \*****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _SingleProductComponent_vue_vue_type_template_id_5575ea18_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SingleProductComponent.vue?vue&type=template&id=5575ea18&scoped=true& */ "./resources/js/components/frontend/product/SingleProductComponent.vue?vue&type=template&id=5575ea18&scoped=true&");
/* harmony import */ var _SingleProductComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SingleProductComponent.vue?vue&type=script&lang=js& */ "./resources/js/components/frontend/product/SingleProductComponent.vue?vue&type=script&lang=js&");
/* harmony import */ var _SingleProductComponent_vue_vue_type_style_index_0_id_5575ea18_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./SingleProductComponent.vue?vue&type=style&index=0&id=5575ea18&scoped=true&lang=css& */ "./resources/js/components/frontend/product/SingleProductComponent.vue?vue&type=style&index=0&id=5575ea18&scoped=true&lang=css&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _SingleProductComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _SingleProductComponent_vue_vue_type_template_id_5575ea18_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _SingleProductComponent_vue_vue_type_template_id_5575ea18_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "5575ea18",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/frontend/product/SingleProductComponent.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/components/frontend/product/SingleProductComponent.vue?vue&type=script&lang=js&":
/*!******************************************************************************************************!*\
  !*** ./resources/js/components/frontend/product/SingleProductComponent.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_SingleProductComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./SingleProductComponent.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/product/SingleProductComponent.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_SingleProductComponent_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/frontend/product/SingleProductComponent.vue?vue&type=style&index=0&id=5575ea18&scoped=true&lang=css&":
/*!**************************************************************************************************************************************!*\
  !*** ./resources/js/components/frontend/product/SingleProductComponent.vue?vue&type=style&index=0&id=5575ea18&scoped=true&lang=css& ***!
  \**************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_10_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_SingleProductComponent_vue_vue_type_style_index_0_id_5575ea18_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./SingleProductComponent.vue?vue&type=style&index=0&id=5575ea18&scoped=true&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-10[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/product/SingleProductComponent.vue?vue&type=style&index=0&id=5575ea18&scoped=true&lang=css&");


/***/ }),

/***/ "./resources/js/components/frontend/product/SingleProductComponent.vue?vue&type=template&id=5575ea18&scoped=true&":
/*!************************************************************************************************************************!*\
  !*** ./resources/js/components/frontend/product/SingleProductComponent.vue?vue&type=template&id=5575ea18&scoped=true& ***!
  \************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_SingleProductComponent_vue_vue_type_template_id_5575ea18_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_SingleProductComponent_vue_vue_type_template_id_5575ea18_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_SingleProductComponent_vue_vue_type_template_id_5575ea18_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./SingleProductComponent.vue?vue&type=template&id=5575ea18&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/product/SingleProductComponent.vue?vue&type=template&id=5575ea18&scoped=true&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/product/SingleProductComponent.vue?vue&type=template&id=5575ea18&scoped=true&":
/*!***************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/frontend/product/SingleProductComponent.vue?vue&type=template&id=5575ea18&scoped=true& ***!
  \***************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  return _c("div", { attrs: { id: "single_product" } }, [
    _c("div", { staticClass: "container single-product-container" }, [
      _c(
        "div",
        { staticClass: "breadcrumb-content single-product-breadcrumb" },
        [
          _c("ul", [
            _c(
              "li",
                  ...
                  "router-link",
                  {
                    attrs: {
                      to: {
                        ...
                        params: { catSlug: _vm.categorySlug }
                      }
                    }
                  },
      ...
      _vm._v(" "),
      _c("div", { staticClass: "single-product-main-section" }, [
        _c("div", { staticClass: "single-product-area" }, [
              ...
              _c("div", { staticClass: "col-md-5" }, [
                _c("div", { staticClass: "product__details__pic" }, [
                  _vm.product.product_images
                    ? _c("div", {}, [
                        _vm.main_image && _vm.main_image.length > 0
                          ? _c(
                              "span",
                              [
                                _c("image-magnifier", {
                  ...
                  _vm.product &&
                  _vm.product.product_images &&
                  _vm.product.product_images.length > 0
                    ? _c(
                        "div",
                        { staticClass: "mt-2" },
                        [
                          _c(
                            ...
                            _vm._l(_vm.product.product_images, function(
                              product_image,
                              index
                            ) {
                              return _c("img", {
                                ...
                                on: {
                                  click: function($event) {
                                    return _vm.showImage(product_image.image)
                                  }
                                }
                              })
                            }),
              ...
              _c("div", { staticClass: "col-md-7" }, [
                _c("div", { staticClass: "single-product-content" }, [
                  ...
                  _c(
                    "div",
                    {
                      staticClass: "single-product-reviews show-rating",
                    ...
                    [
                      ...
                      _vm.product.reviews.length < 2
                        ? _c(
                            ...
                            [
                              _vm._v(
                                _vm._s(_vm.product.reviews.length) + " Review"
                              )
                            ]
                          )
                        : _vm.product.reviews.length >= 2
                        ? _c(
                            ...
                            [
                              _vm._v(
                                _vm._s(_vm.product.reviews.length) + " Reviews"
                              )
                            ]
                          )
                        : _vm._e()
                      ...
                      _vm.product.sales_price
                        ? _c("span", { staticClass: "regular-price" }, [
                            ...
                            _c("span", { staticClass: "price" }, [
                              _vm._v(
                                "৳" +
                                  _vm._s(
                                    _vm._f("numFormat")(_vm.product.sales_price)
                                  )
                              )
                            ])
                          ])
                        : _c("span", { staticClass: "price" }, [
                            _vm._v(
                              "৳" +
                                _vm._s(
                                  _vm._f("numFormat")(_vm.product.regular_price)
                                )
                            )
                          ]),
                      _vm._v(" "),
                  ...
                  _c("div", { staticClass: "product-info" }, [
                    ...
                    _vm.product.short_description != "null"
                      ...
                      : _vm._e(),
                    _vm._v(" "),
                    _vm.product.product_sku && _vm.product.product_sku != "null"
                      ? _c("p", { staticClass: "mt-0 single-product-info" }, [
                          _c("b", [_vm._v("SKU:")]),
                              ...
                              "router-link",
                              {
                                attrs: {
                                  to: {
                                    ...
                                    params: {
                                      brandSlug: _vm.product.brand.brand_slug
                                    }
                                  }
                                }
                              },
                  ...
                  _c("div", { staticClass: "single-product-action" }, [
                    _c("form", { attrs: { action: "#" } }, [
                      _vm.product.product_variations &&
                      _vm.product.product_variations.length > 0
                        ? _c("span", [
                      ...
                      _c("div", { staticClass: "product-add-to-cart" }, [
                        ...
                        _vm.product.status != 0
                          ? _c("p", { staticClass: "text-info" }, [
                              _c("b", [_vm._v(_vm._s(this.product_stock))]),
                              _vm._v(" product left in Stock")
                            ])
                          : _vm._e(),
                        _vm._v(" "),
                        _vm.product.status != 0
                                        ...
                                        _c(
                                          "button",
                                          {
                                            ...
                                            attrs: {
                                              ...
                                              to: {
                                                name: "checkout",
                                                params: { product: _vm.product }
                                              }
                                            },
                                            on: {
                                              click: function($event) {
                                                $event.preventDefault()
                                                return _vm.buyNow(_vm.product)
                                              }
                                            }
                                          },
                                          [
        ...
        _vm._v(" "),
        _vm.product.youtube_link && _vm.product.youtube_link != "null"
          ? _c("div", { staticClass: "container" }, [
          ...
          : _vm._e(),
        _vm._v(" "),
        _c("div", { staticClass: "single-product-review-tab mt-4" }, [
          _c("div", { staticClass: "container" }, [
            _c("div", { staticClass: "row" }, [
              _c("div", { staticClass: "col-md-12" }, [
                _c(
                  "div",
                  { staticClass: "single-product-review-and-description-area" },
                  [
                    _vm._m(0),
                    _vm._v(" "),
                    _c(
                      ...
                      {
                        staticClass:
                          "tab-content product-review-content-tab mt-30",
                        attrs: { id: "myTabContent-4" }
                      },
                      [
                        _c(
                          "div",
                          ...
                          [
                            _c(
                              "div",
                              { staticClass: "single-product-description" },
                              [
                                _c("p", {
                                  domProps: {
                                    innerHTML: _vm._s(
                                      _vm.product.long_description
                                    )
                                  }
                                })
                              ]
                            ...
                            _c("div", { staticClass: "row" }, [
                                ...
                                _c(
                                  ...
                                  [
                                    _vm.product.reviews
                                      ...
                                      : _vm._e(),
                                    _vm._v(" "),
                                    _vm._l(_vm.product.reviews, function(
                                      review
                                    ) {
                                      return _c(
                                        "ol",
                                                  ...
                                                  [
                                                    ...
                                                    "default.png"
                                                      ? _c("img", {
                                                          attrs: {
                                                            src:
                                                              "/assets/frontend/img/icon/user.png",
                                                            width: "50px"
                                                          }
                                                        })
                                                      : _vm._e()
                              ...
                              _c("div", { staticClass: "col-md-6" }, [
                                _vm.user.id
                                  ? _c(
                                      "div",
                                      { staticClass: "review-page-comment" },
                                      [
                                        _c(
                                          "div",
                                  ...
                                  : _c(
                                      ...
                                      {
                                        staticClass:
                                          "review-page-comment bg-danger p-3"
                                      },
                                      [_vm._m(5)]
                                    )
                              ])
    ...
    _vm._v(" "),
    _vm.related_products && _vm.related_products.length > 0
      ? _c("div", { staticClass: "related-product-area mt-4" }, [
          _c("div", { staticClass: "container related-product-container" }, [
            _vm._m(6),
            _vm._v(" "),
            _c("div", { staticClass: "recent-addition mt-4" }, [
              _c("div", { staticClass: "row" }, [
                _c("div", { staticClass: "col-md-12" }, [
                  _c("div", { staticClass: "home-2-product" }, [
                    _vm.related_products && _vm.related_products.length > 0
                      ? _c(
                          "div",
                          { staticClass: "row" },
                          _vm._l(_vm.related_products, function(
                            related_product
                          ) {
                            return _c(
                              "div",
                              {
                                ...
                                staticClass: "col-lg-3 col-xl-3 col-md-3"
                              },
                              [
                                _c(
                                  "div",
                                    ...
                                    _c(
                                      ...
                                      [
                                        ...
                                        _c(
                                          ...
                                          [
                                            _c("ul", [
                                              related_product.product_variations &&
                                              related_product.product_variations
                                                .length > 0
                                                ? _c(
                                                    "li",
                      ...
                      _c("div", { staticClass: "modal-body" }, [
                        _c("div", { staticClass: "row" }, [
                          ...
                          _c("div", { staticClass: "col-md-7" }, [
                            _c(
                              "div",
                              { staticClass: "single-product-content" },
                              [
                                _c(
                                  "h1",
                                  { staticClass: "single-product-name mb-0" },
                                  [_vm._v(_vm._s(_vm.product.product_name))]
                                ),
                                _vm._v(" "),
                                _c(
                                  "div",
                                  { staticClass: "single-product-reviews" },
                                  [
                                    _c(
                                      "div",
                                ...
                                _c("div", { staticClass: "product-info" }, [
                                  ...
                                  _vm.product.product_sku != "null"
                                    ? _c(
                                        ...
                                        {
                                          staticClass:
                                            "mt-0 single-product-info"
                                        },
                                        [
                                          _c("b", [_vm._v("SKU:")]),
                                          _vm._v(
                                            " " +
                                              _vm._s(_vm.product.product_sku)
                                          )
                                        ]
                                      )
                                    : _vm._e(),
                                ...
                                _c(
                                  "div",
                                  { staticClass: "single-product-action" },
                                  [
                                    _c("form", { attrs: { action: "#" } }, [
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("ul", { staticClass: "nav dec-and-review-menu" }, [
      _c("li", [
        _c(
          "a",
          {
            staticClass: "active",
            attrs: { "data-toggle": "tab", href: "#description" }
          },
          [_vm._v("Description")]
        )
      ]),
      _vm._v(" "),
      _c("li", [
        _c("a", { attrs: { "data-toggle": "tab", href: "#reviews" } }, [
          _vm._v("Reviews")
        ])
      ])
    ])
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("label", { staticClass: "label-quality" }, [
      _vm._v("Quality"),
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("p", { staticClass: "required-fields" }, [
      _c("sup", [_vm._v("*")]),
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "review-comment" }, [
      _c("h4", { staticClass: "text-white text-center" }, [
        _vm._v("Please Login First for Review.")
      ])
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-12" }, [
        _c("div", { staticClass: "text-center" }, [
          _c("h3", [_vm._v("You may also like")])
        ])
      ])
    ])
  },
