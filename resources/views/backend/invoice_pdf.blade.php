...
<div class="row first-section">
    <div class="column f1" style="@if($order->ship_to_gift == 1) width: 66% !important @else width: 60% !important @endif">
        <img class="company-logo" src="{{ asset('assets/frontend/img/logo/logo.png') }}" alt="" style="width:100px !important;">
    </div>
...
<!--Start Second Section-->
<div class="row second-section" style="margin-top: 10px !important">
...
<div class="row third-section">
    ...
    <div class="column sec3" style="margin-top: 30px !important; @if($order->ship_to_gift == 1) width: 33% !important; @else width: 33% !important; @endif">
                        ...
                        @if($order->order_attributes)
                            @foreach ($order->order_attributes as $attribute)
                                @if ($attribute->product_id == $order_detail->product['id'])
                                    ...
                                    @if($attribute->color && $attribute->size)<span>,</span>@endif
                                    @if($attribute->size)<span><b>Size:</b> {{ $attribute->size }}</span>@endif
                                    @if($attribute->size && $attribute->weight)<span>,</span>@endif
