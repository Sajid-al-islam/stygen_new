<div>
    <div class="container">
        @if($occasion->occasion_image)
        <div class="slider-area">
            <div class="active">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="">
                            <img src="assets/uploads/occasion/{{ $occasion->occasion_image }}" alt="category banner">
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-12 col-lg-3 col-xl-3 col-md-3 mb-3">
                                    ...
                                    <div class="single-product mb-3 shop-product-single">
                                        <div class="product-img product-img-category">
                                            ...
                                            {{-- @if (discount_percentage($product->regular_price,
                                            $product->sales_price))
                                            <span class="sticker">{{ discount_percentage($product->regular_price,
                                        ...
                                        <div class="product-content">
                                            ...
                                            <div class="product-price">
                                                ...
                                                <div class="d-inline-flex gap-2 justify-content-between mt-3">
                                                    ...
                                                    @if ($product->purchase_stock_sum_qty - $product->sell_stock_sum_qty
                                                    > 1 && $product->status == 1)
                                                    <div class="col-md-6 col-sm-6 col-lg-6 col-6">
                                                        @if ($product->product_variations &&
                                                        count($product->product_variations) > 0)
                                                        <span><a class="btn btn-primary btn-sm ps-2 detailsbtn mb-2"
                                                                href="{{ route('product_details', $product->pro_slug) }}">select
                                                                variant</a></span>
                                                        @else
                                                        @php
                                                        $product_data = [];
                                                        ...
                                                        <span>
                                                            <button type="button"
                                                                class="btn btn-primary btn-sm pe-2 addtocart mb-2"
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-lg-6 col-6">
                                                        <span><a class="btn btn-primary btn-sm ps-2 detailsbtn"
                                                                href="{{ route('product_details', $product->pro_slug) }}"><i
                                                                    class="fas fa-eye pe-2"></i>Details</a></span>
                                                    </div>
                                                    @else
                                                    <div class="col-12">
                                                        <h4>Out of stock</h4>
                                            ...
                                            <div class="product-reviews d-flex justify-content-center mt-0">
                                                <div class="show-rating">
                                                    ...
                                                    <star-rating :rating="{{ $product->average_ratting }}"
                                                        :show-rating="false" :read-only="true" :increment="0.01">
                                                    </star-rating>
                                                    @endif
                                                </div>
                                            </div>
