            ...
            @if ($category->occasion_image)
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <img src="/assets/uploads/slider/{{ $category->occasion_image }}">
    </div>
</div>
@endif
                            ...
                            <div class="single-product mb-3 shop-product-single">
                                <div class="product-img product-img-category">
                                    <a href="{{ route('product_details', $product->pro_slug) }}" class="w-100">
                                        ...
                                        <img class="first-img lazy" src="/assets/uploads/product/{{ $product->featured_image }}" alt="{{ $product->id }}" loading="lazy">
                                        @else
                                        <img class="first-img lazy" src="/assets/frontend/img/icon/empty_product.jpeg" loading="lazy">
                                        @endif
                                    </a>
