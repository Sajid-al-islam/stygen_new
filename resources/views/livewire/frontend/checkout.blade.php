                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="checkout-form-list">
                                            ...
                                            <input name="address" placeholder="e.g. House#1, Road#1, Dhaka"
                                                type="text">
                                ...
                                <div class="different-address">
                                    <div class="ship-different-title">
                                        <h3>
                                            ...
                                            <input id="ship-box" name="shippingDisplay" value="ship_to_other"
                                                type="checkbox">
                                        </h3>
                                    </div>
                                    <div id="ship-box-info" class="row d-block">
                                        ...
                                        <div class="col-md-12">
                                            <div class="checkout-form-list">
                                                <label>Address <span class="required">*</span></label>
                                                <input name="shipping_address" placeholder="e.g. House#1, Road#1, Dhaka"
                                                    type="text">
                                        ...
                                        <div class="col-md-12">
                                            <div class="checkout-form-list">
                                                <label>Email Address</label>
                                                <input name="shipping_email" placeholder="e.g. example@example.com"
                                                    type="email">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="checkout-form-list">
                                                <label>Phone <span class="required">*</span></label>
                                                <input name="shipping_phone" placeholder="e.g. 01xxxxxxxxx"
                                                    type="number">
                                        ...
                                        <div class="col-md-12">
                                            <div class="order-notes">
                                                <div class="checkout-form-list">
                                                    ...
                                                    <textarea name="personal_notes" id="checkout-mess" cols="30" rows="10"
                                                        placeholder="e.g. Personal notes for the recipient."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            @if (count($cards) > 0)
                                                <div class="country-select clearfix">
                                                    ...
                                                    <select @change.prevent="changeGreetingsCard($event)"
                                                        v-model="card_id" class="form-control">
                                        ...
                                        <div class="col-md-12">
                                            @if (count($packagings) > 0)
                                                <div class="country-select clearfix">
                                                    ...
                                                    <select @change.prevent="changePackaging($event)"
                                                        v-model="packaging_id" class="form-control">
                                                        <option value="0">Select Packaging</option>
                                                        @foreach ($packagings as $packaging)
                                                            <option value="{{ $packaging['price'] }}">
                                                                {{ $packaging['name'] }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            @endif
                                            ...
                                            @foreach ($carts as $cart)
                                                ...
                                                <tr class="cart_item">
                                                    <td class="cart-product-name">
                                                        {{ $cart['product']['product_name'] }}<strong
                                                            class="product-quantity"> × {{ $cart['qty'] }}</strong>
                                                    </td>
                                                    <td class="cart-product-total"><span
                                                            class="amount">৳{{ $cart['qty'] * $cart['product']['regular_price'] }}</span>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                        <tfoot>
                                            ...
                                            <tr class="order-total">
                                                ...
                                                <td><strong><span class="amount">৳
                                                            {{ number_format($cart_total) }}</span></strong></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                                    ...
                                    <div class="payment-accordion">
                                        <div id="accordion">
                                            ...
                                            <div class="card">
                                                <div class="row mb-2">
                                                    <div class="col-md-4 col-sm-12 col-12">
                                                        <div class="payment_single text-center">
                                                            <a class="btn" data-toggle="collapse"
                                                                data-target="#cashOnDelivery" aria-expanded="true"
                                                                aria-controls="cashOnDelivery">
                                                                <img src="assets/frontend/img/cart/cash-on-delivery.png"
                                                                    class="img-fluid mx-auto d-block mb-2">
                                                                <span><i class="fas fa-truck"></i><b>Cash On
                                                                        Delivery</b></span>
                                                            </a>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="card-header" id="#payment-2">
                                                                <h5 class="panel-title">
                                                                    <a class="btn" data-toggle="collapse"
                                                                        ...
                                                                        <img src="assets/frontend/img/cart/secure.png"
                                                                            class="img-fluid mx-auto d-block mb-2">
                                                    ...
                                                    <div class="col-md-4 col-sm-12 col-12">
                                                        <div class="payment_single text-center">
                                                            <a class="btn" data-toggle="collapse"
                                                                data-target="#bkash_pay" aria-expanded="true"
                                                                aria-controls="bkash_pay">
                                                                <img src="assets/frontend/img/cart/bkash.svg"
                                                                    class="img-fluid mx-auto d-block mb-2">
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="bkash_pay" class="collapse show" data-parent="#accordion">
                                                    <div class="card-body">
                                                        @if ($cart_total > 0)
                                                            <div class="order-button-payment">
                                                                <button class="btn btn-block" type="submit">Place
                                                                    Order</button>
                                                            </div>
                                                        @endif
                                                    </div>
                                                        ...
                                                        @if ($cart_total > 0)
                                                            <div class="order-button-payment">
                                                                <button id="bKash_button"
                                                                    class="bkash_btn btn btn-block" type="button">Bkash</button>
                                                            </div>
                                                        @endif
                                                    </div>
                                                </div>
